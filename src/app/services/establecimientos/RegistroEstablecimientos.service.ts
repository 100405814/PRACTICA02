...
export class RegistroEstablecimientos {
    ...
    public datos: Establecimiento[] = [
      {id:0 , nombre:'El Ristorante Di Giorgio', tipo_comida:1, distancia:1.2, aforo_actual:10, aforo_maximo:35, direccion:'Calle de Abizanda, 12', valoracion:4.3, medidas_covid:['Máximo número de personas por mesa: 6', 'Aforo limitado', 'Distancia interpersonal: 2 (metros)'], terraza:false, imagen:'https://100405814.github.io/PRACTICA02/assets/images/restaurants/ElristorantedeGiorgio.png'},
      {id:1 , nombre:'La Taberna de Pepe', tipo_comida:2, distancia:0.5, aforo_actual:7, aforo_maximo:20, direccion:'Calle de Amaya, 3', valoracion:4.5, medidas_covid:['Máximo número de personas por mesa: 4', 'Aforo limitado', 'Distancia interpersonal: 2.5 (metros)'], terraza:true, imagen:'https://100405814.github.io/PRACTICA02/assets/images/restaurants/latabernadePepe.jpg' },
